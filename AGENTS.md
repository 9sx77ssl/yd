...
src/
  ...
  wallet/        # domain
    mod.rs       #   facade
    model.rs     #   NetworkKind, EvmNetworkConfig, UtxoNetworkConfig, SolanaNetworkConfig, TonNetworkConfig, PortfolioEntry
    ...
    ton.rs       #   TonProvider (SLIP-0010 derivation, v4R2 StateInit, CRC16 address encoding)
